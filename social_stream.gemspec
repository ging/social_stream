...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('social_stream-documents', '~> 0.11.0')
  s.add_runtime_dependency('social_stream-events', '~> 0.8.0')
  s.add_runtime_dependency('social_stream-linkser', '~> 0.6.0')
  s.add_runtime_dependency('social_stream-presence', '~> 0.7.3')
