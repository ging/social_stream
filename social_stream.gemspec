...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('social_stream-documents', '~> 2.0.0.beta1')
  s.add_runtime_dependency('social_stream-events', '~> 2.0.0.beta1')
  s.add_runtime_dependency('social_stream-linkser', '~> 2.0.0.beta1')
  s.add_runtime_dependency('social_stream-presence', '~> 2.0.0.beta1')
  s.add_runtime_dependency('social_stream-ostatus', '~> 2.0.0.beta1')
  s.add_runtime_dependency('social_stream-oauth2_server', '~> 2.0.0.beta1')
