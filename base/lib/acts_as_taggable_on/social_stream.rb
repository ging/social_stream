# We upgrade acts_as_taggable_on from 2.2.2 to the version 2.4.1, in order to support the ActsAsTaggableOn.strict_case_match feature.
# The following methods were responsable of overriding the old acts_as_taggable_on methods.
# We keep it for possible future modifications.
